...
#include "Psico/Events/ApplicationEvent.h"
...
namespace Psico
{
	...
	{
		PS_CORE_ERROR("GLFW Error ({0}): ", description);
	}
	...
	void WindowsWindow::Init(const WindowProps& props)
	{
		...
		{
			// should terminate on system shutdown
		...
		glfwSetCursorEnterCallback(m_Window, [](GLFWwindow* window, int entered)
			{
				...
				MousePassedWindowBorderEvent event(entered);
				data.EventCallback(event);
